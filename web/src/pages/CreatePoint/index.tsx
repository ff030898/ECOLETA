...
//toda vez que criar um estado para um array ou objeto precisamos informar o tipo da variavel que vai ficar ali dentro. Por isso usa a interface
...
const CreatePoint = () => {
    ...
    //useEffect com [] no final Significa que só vai executar uma única vez o estado
    useEffect(() => {
    ...
    async function handleSubmit(event: FormEvent){
      ...
      //Permanece na msm página dps do envio  
